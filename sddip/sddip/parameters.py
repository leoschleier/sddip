...
class Parameters:
    ...
    def init_deterministic_parameters(self):
        ...
        self.cost_coeffs = self.gc.tolist() + self.suc.tolist() + self.sdc.tolist() + [self.penalty]*2
    ...
    def init_stochastic_parameters(self):
        ...
        for t in range( self.n_stages):
            ...
            p_d.append(
                    stage_df[scenario_df.columns[scenario_df.columns.to_series().str.contains('Pd')]].values.tolist())
