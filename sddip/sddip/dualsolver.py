...
class SubgradientMethod:
    ...
    def __init__(self, max_iterations = 1000, tolerance = 10**(-3), initial_lower_bound = 0) -> None:
    ...
    def solve(self, model: gp.Model, objective_terms, relaxed_terms, upper_bound: float = None) -> gp.Model:
    ...
    def get_step_size(self, method = "css", gradient_magnitude = None, step_size_parameter = None, upper_bound = None, 
            opt_value = None):
        ...
        elif method == "dss" and gradient_magnitude != None and step_size_parameter != None and upper_bound != None \
                and opt_value != None:
            # Dependent step size
    ...
    def print_iteration_info(self, iteration:int, opt_value: float, gradient_magnitude:float, step_size:float = None):
